...
3. Ensure version and feature list match the release.
...
2. Exclude large training repos or sample data from the release zip.
3. Verify the zip installs in Blender without errors.

**Release**
1. Create a changelog summary for the release notes.
